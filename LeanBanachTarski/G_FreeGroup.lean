...
lemma rotate_preserves_gl_a (n1 : Nat) (a1 b1 c1 : ℤ)  (i : r_3) (h : i = a_b_c_vec a1 b1 c1 n1) :
...
lemma rotate_preserves_gl_b (n1 : Nat) (a1 b1 c1 : ℤ)  (i : r_3) (h : i = a_b_c_vec a1 b1 c1 n1) :
...
theorem lemma_3_1 {n : Nat} (p : List (Generator × Bool))  (h: List.length p = n):
    ...
    | cons head tail ih  =>
      ...
      | succ d =>
          ...
          | mk fst snd =>
            ...
            cases fst
            . cases snd
              . rw [rotate_preserves_gl_a' d a3 b3 c3]
                use 3 * a3
                use b3 - 4 * c3
                use 2 * b3 + c3
            ...
            . cases snd
              . rw [rotate_preserves_gl_b' d a3 b3 c3]
                use a3 - 2 * b3
                use 4 * a3 + b3
                use 3 * c3
                simp [rotate, a_b_c_vec]
